...
def create_Figure14_CSS_Eligibility2(type, colours, parital_output_path, data_label_font_dict_white, data_label_font_dict_black, brace_label_font_dict):
    ###########
    # Main script Notifications
    if type==0:
        print('Figure14_CSS_Eligibility2')

    if type==1:
        print('Accessible_Figure14_CSS_Eligibility2')
    ###########
    ...
    }, index=["Works not started", "Works started", "Works completed", "Live application", "Pre - application"])
    ...
    if type==0:
        output_path = f'{parital_output_path}Figure14_CSS_Eligibility2.svg'

    if type==1:
        output_path = f'{parital_output_path}Accessible_Figure14_CSS_Eligibility2.svg' 
