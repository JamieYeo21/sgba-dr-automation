...
def create_ACM_Remediation(type, figure_count, colours, grey, parital_output_path, data_label_font_dict_white, data_label_font_dict_black, brace_label_font_dict):
    ###########
