...
def create_Developer_Remediation_Curly(type, figure_count, colours, grey, parital_output_path, data_label_font_dict_white, data_label_font_dict_black, brace_label_font_dict):
    ###########
