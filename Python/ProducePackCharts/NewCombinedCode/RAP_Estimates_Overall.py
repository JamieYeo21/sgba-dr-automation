...
def create_11m_RAP_estimates(type, figure_count, colours, grey, secondary_grey, partial_output_path, MI_folder_path, data_label_font_dict_white, data_label_font_dict_black):
    ###########
